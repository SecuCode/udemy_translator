...
export const metadata: Metadata = {
  title: '공지사항 | 메타자산운용(주)',
  description: '메타자산운용의 공지사항을 안내합니다.',
};

const announceItems = NOTICES.filter(n => n.category === '공지');
    ...
    <div className={styles.page}>
      <aside className={styles.sidebar}>
        ...
        <div className={styles.sidebarMeta}>
          <p className={styles.sidebarCategory}>공지사항</p>
          <p className={styles.sidebarDesc}>
            메타자산운용의 공지사항을 안내드립니다.
          </p>
          <div className={styles.tabs}>
            <Link href="/notice/announce" className={`${styles.tab} ${styles.tabActive}`}>공지사항</Link>
